...
# st.set_page_config(
#     page_title="Environment Missing Data",
#     layout="wide"
# )
...
# Enter the total weight or volume of materials used to produce and package the organization’s primary products and services during the reporting period.
# """)

# col1, col2 = st.columns(2)

# with col1:
#     non_renewable_materials = st.number_input(
...
# with col2:
#     renewable_materials = st.number_input(
...
# total_materials = non_renewable_materials + renewable_materials

# st.metric(
#     label="Total Weight or Volume",
#     value=f"{total_materials:.2f}"
# )

# # Optional Save Button
# if st.button("Save Data"):
#     st.success("GRI 301-1 data saved successfully.")
...
# with col1:
#     recycled_materials = st.number_input(
...
# with col2:
#     total_input_materials = st.number_input(
...
# # Formula Calculation
# if total_input_materials > 0:
#     recycled_percentage = (
#         recycled_materials / total_input_materials
#     ) * 100
# else:
...
#     value=f"{recycled_percentage:.2f}%"
# )


# if st.button("Save Data-2"):
#     st.success("GRI 301-2 data saved successfully.")
...
# with col1:
#     Products_and_their_packaging_materials = st.number_input(
...
# with col2:
#     Products_sold_within_the_reporting_period = st.number_input(
...
# # Formula Calculation
# if Products_and_their_packaging_materials > 0:
#     recycled_percentage = (
#         Products_and_their_packaging_materials / Products_sold_within_the_reporting_period
#     ) * 100
# else:
#     recycled_percentage = 0.0
...
#         placeholder="Describe how the data for GRI 301-3 have been collected...",
#         height=150
#     )
# with col2:
...
# if st.button("Save Data-3"):
#     st.success("GRI 301-3 data saved successfully.")
...
# with col1:
#     energy_consumption_outside = st.number_input(
...
#     st.text_area(
#         label="Data Collection Methodology",
#         placeholder="Standards, methodologies, assumptions...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 302-2B ",
#         type=["pdf", "docx", "xlsx"]
#     )   
...
# with col1:
#     st.text_area(
#         label="Enter the sources",
#         placeholder="Source of the conversion factors used....",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 302-2C ",
#         type=["pdf", "docx", "xlsx"]
#     )   


# if st.button("Save Data-4"):
#     st.success("GRI 302-2 data saved successfully.")
...
#         "Energy Reductions in energy requirements",
#         min_value=0.0,
#         step=0.01,
#         format="%.2f"
#     )
...
# with cols2:
#     energy_reduction = st.text_area(
#         label="Justification for Baseline or Base Year",
#         placeholder="Enter the energy reductions...",
#         height=150
#     )
# with col1:
#     energy_unit = st.selectbox(
#     "Select Baseline Or BaseYear",
#     [
#        "Base Year",
#        "Baseline"
#     ]
...
# with col1:
#     st.text_area(
#         label="Enter the Standards, methodologies, assumptions, and/or calculation tools used",
#         placeholder="Standards, methodologies, assumptions...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 302-5C ",
#         type=["pdf", "docx", "xlsx"]
#     )   


# if st.button("Save Data-5"):
#     st.success("GRI 302-5 data saved successfully.")
...
# with col1:
#     st.text_area(
#         label="Interactions with water and water-related impacts",
#         placeholder="Describe how the organization interacts with water(withdrawn, consumed, discharged) and water-related impacts(Economy, Environment, People)...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-1A ",
#         type=["pdf", "docx", "xlsx"]
#     )   
...
# with col1:
#     st.text_area(
#         label="Approach used to identify water-related impacts",
#         placeholder="Describe the Scope of assessments, their timeframe, and any tools or methodologies used to identify water-related impacts...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-1B ",
#         type=["pdf", "docx", "xlsx"]
#     ) 
...
# with col1:
#     st.text_area(
#         label="How water-related impacts are addressed",
#         placeholder="Describe how the organization works with stakeholders to steward water as a shared resource, and how it engages with suppliers or customers with significant water-related impacts...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-1C ",
#         type=["pdf", "docx", "xlsx"]
#     ) 
...
# with col1:
#     st.text_area(
#         label="Process for setting water-related goals and targets",
#         placeholder="Describe the process for setting water-related goals and targets, and how they relate to public policy and the local context of each area with water stress...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-1D ",
#         type=["pdf", "docx", "xlsx"]
#     )     

# if st.button("Save Data-6"):
#     st.success("GRI 303-1 data saved successfully.")


# ## GRI 303-2 Water discharge by quality and destination
...
# with col1:
#     st.text_area(
#         label="Minimum effluent discharge standards and determination method",
#         placeholder="What minimum water quality standards do you follow before discharging waste water and how were those standards determined....",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-2A ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
# st.write("""A-i. how standards for facilities operating in locations with no local discharge
...
# with col1:
#     st.text_area(
#         label="Basis for determining effluent discharge standards in absence of local regulations",
#         placeholder="Describe the standards to determine the discharge of waste water in absence of local regulations and outdated laws....",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-2A.i ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
#         "Any internally developed standards?",
#         ["Select", "Yes", "No"]
#     )
...
#             label="Explain internal standards/guidelines",
#             placeholder="Describe internally developed water quality standards or guidelines...",
#             height=150
#         )
...
# with col1:
#     has_sector_specific = st.selectbox(
#         "Any sector-specific standards?",
#         ["Select", "Yes", "No"]
#     )

# with col2:
#     if has_sector_specific == "Yes":
#         sector_specific_explain = st.text_area(
#             label="Explain sector-specific standards/guidelines",
#             placeholder="Describe sector-specific water quality standards or guidelines...",
#             height=150
#         )

# with col3:
#     if has_sector_specific == "Yes":
#         sector_specific_file = st.file_uploader(
#             label="Upload Supporting Document",
#             type=["pdf", "docx", "xlsx"],
#             key="sector_specific_standard_upload"
#         )
...
# with col1:
#     st.text_area(
#         label="Assessment of receiving waterbody conditions before discharge",
#         placeholder="Describe whether the profile of the receiving waterbody was considered before discharging waste water and how it influenced discharge standards....",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 303-2A.iv ",
#         type=["pdf", "docx", "xlsx"]
#     )


# if st.button("Save Data-7"):
#     st.success("GRI 303-2 data saved successfully.")
...
# with col1:
#     st.text_area(
#         label="The inputs, activities, and outputs that lead or could lead to these impacts",
#         placeholder="Describe the inputs,activities and output that lead or could lead to waste related impacts",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 306-A1 ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
# with col1:
#     st.text_area(
#         label="""Source of the waste-related impacts (own operations, upstream/downstream value chain).""",
#         placeholder="Describe the occurence of waste-related impact due to organization activities or value chain(upstream/downstream)",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 306-A2 ",
#         type=["pdf", "docx", "xlsx"]
#     )

# if st.button("Save Data-8"):
#     st.success("GRI 306 data saved successfully.")    
...
# with col1:
#     st.text_area(
#         label="""Actions & circularity measures taken to prevent and manage waste-related impacts across operations and the value chain.""",
#         placeholder="Describe the actions and circulatory measures taken.",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 306-A ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
# with col1:
#     st.text_area(
#         label="""Processes used to ensure third parties manage waste in compliance with contractual and legal requirements..""",
#         placeholder="Processes used to ensure third-party waste management complies with contractual and legal requirements...",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 306-B ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
# with col1:
#     st.text_area(
#         label="""The processes used to collect and monitor waste-related data.""",
#         placeholder="Describe the processes used to collect and monitor waste-related data.",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 306-C ",
#         type=["pdf", "docx", "xlsx"]
#     )

# if st.button("Save Data-9"):
#     st.success("GRI 306 data saved successfully.")  
...
# with col1:
#     st.text_area(
#         label="""Percentage of new suppliers that were screened using environmental criteria.""",
#         placeholder="(New suppliers screened/total number of suppliers)*100 ",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 308-1 ",
#         type=["pdf", "docx", "xlsx"]
#     )
# st.write("""
...
# with col1:
#     st.text_area(
#         label="""A. Number of suppliers assessed for environmental impacts """,
#         placeholder=".... ",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 308-2A ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
# with col1:
#     st.text_area(
#         label="""B. Number of suppliers identified as having significant actual and potential negative environmental impacts. """,
#         placeholder=".... ",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 308-2B ",
#         type=["pdf", "docx", "xlsx"]
#     )   
...
# with col1:
#     st.text_area(
#         label="""C. Significant actual and potential negative environmental impacts identified in the supply chain. """,
#         placeholder=".... ",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 308-2C ",
#         type=["pdf", "docx", "xlsx"]
#     )  
...
# with col1:
#     st.text_area(
#         label="""D. Percentage of suppliers identified as having significant actual and potential negative
# environmental impacts with which improvements were agreed upon as a result of
# assessment. """,
#         placeholder="After finding environment problems how many suppliers agreed to fix them... ",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 308-2D ",
#         type=["pdf", "docx", "xlsx"]
#     )
...
# with col1:
#     st.text_area(
#         label="""E. Percentage of suppliers identified as having significant actual and potential negative
# environmental impacts with which relationships were terminated as a result of
# assessment, and why. """,
#         placeholder="How many suppliers were removed or had contracts cancelled due to environmental issues... ",
#         height=150
#     )
# with cols2:
#     file = st.uploaded_file = st.file_uploader(
#         label="Upload Supporting Document for GRI 308-2E ",
#         type=["pdf", "docx", "xlsx"]
#     )        
